...
<pre class="prettyprint" name="code"><code class="hljs bash has-numbering" onclick="mdcp.copyCode(event)" style="position: unset;"> void reserve(size_<span class="hljs-built_in">type</span> n) {
  	<span class="hljs-keyword">if</span> (capacity() &lt; n) {
      const size_<span class="hljs-built_in">type</span> old_size = size();
...
<pre class="prettyprint" name="code"><code class="hljs scss has-numbering" onclick="mdcp.copyCode(event)" style="position: unset;">void <span class="hljs-function">resize(size_type new_size, const T&amp; x)</span> {
    if (new_size &lt; <span class="hljs-function">size()</span>) 
      <span class="hljs-function">erase(<span class="hljs-function">begin()</span> + new_size, <span class="hljs-function">end()</span>)</span>;
    else
      <span class="hljs-function">insert(<span class="hljs-function">end()</span>, new_size - <span class="hljs-function">size()</span>, x)</span>;
  }
</pre>